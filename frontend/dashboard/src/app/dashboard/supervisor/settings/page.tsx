...
import { Settings, Users, Lock, LogOut, CheckCircle2, XCircle, Building2 } from "lucide-react";
    ...
    <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6 max-w-4xl mx-auto">
      ...
      <motion.div variants={fadeUp}>
        ...
        <p className="text-sm text-surface-500 dark:text-surface-400 mt-1">
          Manage your account profile and department security preferences.
        </p>
      </motion.div>
        ...
        <motion.div variants={fadeUp} className="flex-1 stat-card">
          {activeTab === "profile" ? (
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-surface-50 dark:bg-white/[0.02] rounded-xl border border-surface-100 dark:border-white/[0.04] space-y-2">
                <p className="text-xs text-surface-500">Department Name</p>
                <p className="text-base font-bold text-surface-900 dark:text-white">{user.department || "IT Department"}</p>
                <p className="text-xs text-surface-500 pt-2">Role Permissions</p>
                <p className="text-xs font-medium text-emerald-600 dark:text-emerald-400 capitalize">{user.role}</p>
              </div>
            </div>
          ) : (
            <div className="space-y-6">
